    ...
    useEffect(() => {
        const fetchPatientRecords = async () => {
          ...
          try {
            ...
            const filteredRecords = res.data.filter(record => record.user_id === userData.user_id);
        ...
        fetchPatientRecords();
      }, [userData.user_id]);  // Add userData.user_id as a dependency to ensure the effect runs when it changes
